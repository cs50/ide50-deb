...
// modules
var argv =
    require('/usr/lib/node_modules/optimist').boolean(['d','h','v','c'])
    .alias('d', 'debug').alias('h', 'help').alias('v', 'version').alias('c', 'coupon').argv;
var async = require('/usr/lib/node_modules/async');
var child_process = require('child_process');
var fs = require('fs');
var JSZip = require('/usr/lib/node_modules/node-zip');
var path = require('path');
var request = require('/usr/lib/node_modules/request');
var _ = require('/usr/lib/node_modules/underscore');
var wrench = require('/usr/lib/node_modules/wrench');
